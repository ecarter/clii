    ...
    set.args.forEach( function(arg) {
      ...
      if ( option ) {
        ...
        if ( option.params ) {
          ...
          // if option doesn't specify parameters, set true
          matched[ option.name.toProp() ] = true;
        }
        
        // TODO: where is --no-option (boolean false options) ???
