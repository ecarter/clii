...
cli.prototype.option = cli.prototype.opt = cli.prototype.o = function ( option_str, opts, fn ) {
...
cli.prototype._help = true;

cli.prototype.main = cli.prototype.run = function ( fn, args ) {
...
cli.prototype.name = function ( str ) {
  if (str) {
    this._name = str;
    return this;
  } else {
...
cli.prototype.doOption = function ( opt, args ) {
...
cli.prototype.arg = function ( arg ) {
...
cli.prototype.getOption = function ( arg ) {
...
cli.prototype.props = {}; // the arguments that is passed to cli.main()

cli.prototype.parseArgs = cli.prototype.parse = function ( args ) {
...
cli.prototype.version = cli.prototype.v = function ( vstr ) {
  if ( vstr ) {
    this._version = vstr;
    return this;
  } else {
...
cli.prototype._version = cli.prototype.version();
